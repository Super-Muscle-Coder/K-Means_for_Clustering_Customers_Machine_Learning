...
graph_output_dir = r"C:\Project\Machine_Learning\Machine_Learning\graph\Training\With Library\ProductChannel_WL\\"
...
log_file = os.path.join(report_dir, f"ProductChannel.log")  
