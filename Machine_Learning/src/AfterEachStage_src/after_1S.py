...
# ==================================================================================================================
    ...
    def __init__(self, original_dataset_path, cleaned_dataset_path):
        ...
        self.output_dir = Path(r"C:\Project\Machine_Learning\Machine_Learning\report\AfterEachStage_report")
        
        # Tạo thư mục cho figures
        self.fig_dir = Path(r"C:\Project\Machine_Learning\Machine_Learning\graph\AfterEachStage_graph\after_1S_graph")
...
# ==================================================================================================================
    ...
    def print_and_log(self, text, bold=False):
        ...
        if bold:
            print("\033[1m" + text + "\033[0m")  # Bold text in console
            formatted_text = "=" * 100 + "\n" + text + "\n" + "=" * 100
        else:
            print(text)
            formatted_text = text
